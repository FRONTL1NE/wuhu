...
CREATE TABLE `users` (
  ...
  `venue` text NULL DEFAULT NULL,
  `will-submit-demo` tinyint(4) NOT NULL,
  `will-submit-glsl` tinyint(4) NOT NULL,
  `will-submit-wild` tinyint(4) NOT NULL,
  `will-submit-music` tinyint(4) NOT NULL,
  `will-submit-gfx` tinyint(4) NOT NULL,
  `hype` text NULL DEFAULT NULL,
